...
void LAppModel::Initialize(const csmChar* dir, const csmChar* fileName)
{
    _modelHomeDir = dir;
...
void LAppModel::DoDraw()
{
    ...
    GetRenderer<::CubismRenderer_Raylib>()->DrawModel();
}
...
void LAppModel::Draw(CubismMatrix44& matrix)
{
    ...
    GetRenderer<CubismRenderer_Raylib>()->SetMvpMatrix(&matrix);
...
void LAppModel::SetupTextures()
{
    for (csmInt32 modelTextureNumber = 0; modelTextureNumber < _modelSetting->GetTextureCount(); modelTextureNumber++)
    {
        ...
        GetRenderer<CubismRenderer_Raylib>()->LoadModelTexture(modelTextureNumber, texturePath.GetRawString());
    }

#ifdef PREMULTIPLIED_ALPHA_ENABLE
    GetRenderer<Rendering::CubismRenderer_OpenGLES2>()->IsPremultipliedAlpha(true);
#else
    GetRenderer<CubismRenderer_Raylib>()->IsPremultipliedAlpha(false);
#endif
